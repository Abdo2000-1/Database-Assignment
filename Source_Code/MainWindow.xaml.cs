...
namespace MediaProductionManagementSystem
{
    public partial class Form1 : Form
    {
        ...
        private void SetupUIForTable(string table)
        {
            ...
            {
                case "EQUIPMENT":
                    SetField(1, "EQ_ID"); SetField(2, "SERIAL_NUM"); SetField(3, "EQ_TYPE"); SetField(4, "STATUS");
                    break;
                case "PROFESSIONAL":
                    SetField(1, "PROFESSIONAL_ID"); SetField(2, "SKILL_ID"); SetField(3, "PRO_NAME"); SetField(4, "ROLE");
                    break;
                case "PROJECT":
                    SetField(1, "ID"); SetField(2, "TITLE"); SetField(3, "BUDGET"); SetField(4, "DEADLINE");
                    break;
                case "SESSION":
                    SetField(1, "SESS_ID"); SetField(2, "ID"); SetField(3, "ID_STUDIO"); SetField(4, "SESS_DATE");
                    break;
                case "SESSION_EQUIP":
                    SetField(1, "EQ_ID"); SetField(2, "SESS_ID"); SetField(3, "PROFESSIONAL_ID"); SetField(4, "RETURN_CONDITION");
                    break;
                case "SKILLS":
                    SetField(1, "SKILL_ID"); SetField(2, "TECH_SKILL");
                    break;
                case "STUDIO":
                    SetField(1, "ID_STUDIO"); SetField(2, "NAME"); SetField(3, "TYPE"); SetField(4, "WING"); SetField(5, "AVAILABILITY");
                    break;
                case "WORK_ON":
                    SetField(1, "SESS_ID"); SetField(2, "PROFESSIONAL_ID");
                    break;
            }
        }
